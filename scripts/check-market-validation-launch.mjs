...
expect("launch touch packet writes human execution sheet", launchTouchPacketScript.includes("executionCsvPath") && launchTouchPacketScript.includes("manual-touch-execution.csv") && launchTouchPacketScript.includes("response_status") && launchTouchPacketScript.includes("qualified_reason") && launchTouchPacketScript.includes("skip_reason"));
...
expect("launch zip builder packages latest handoff without sending", read("scripts/build-launch-zip.mjs").includes("smirk-launch-packet.zip") && read("scripts/build-launch-zip.mjs").includes("No outreach was sent.") && read("scripts/build-launch-zip.mjs").includes("telegram-handoff.txt"));
