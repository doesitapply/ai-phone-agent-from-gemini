...
const packet = [
  ...
  ...(requiresBranchReconcile
    ...
    : [
        ...
        "```",
        "",
        "After deploy, run `npm run -s check:ship-live`. Only then request separate approval for the signed Stripe webhook smoke, cleanup apply, and one pinned real proof call.",
        "",
      ]),
  "",
  ...
  "2. If post-deploy live checks pass, request separate approval for the signed Stripe smoke.",
