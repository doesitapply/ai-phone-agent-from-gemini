...
expect("checkout metadata carries selected plan", includes("buyerRoutes", "metadata: {") && includes("buyerRoutes", "plan: plan.id"));
expect("subscription metadata carries selected plan", includes("buyerRoutes", "subscription_data:") && includes("buyerRoutes", "plan: plan.id"));
