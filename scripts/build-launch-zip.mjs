...
const handoffText = [
  "SMIRK Telegram / Hermes Handoff - PAUSED",
  "",
  `Zip file: ${latestZipPath}`,
  `Archive copy: ${archivePath}`,
  "",
  "Current directive:",
  "1. Do not open Telegram for this packet.",
  "2. Do not upload this zip to Hermes.",
  "3. Do not draft, send, or queue outreach from this zip.",
  "4. First deploy and verify the hardened approval path with a fake target.",
  "5. After that proof passes, produce the first three drafts for human review only.",
  "",
  "Guardrails:",
