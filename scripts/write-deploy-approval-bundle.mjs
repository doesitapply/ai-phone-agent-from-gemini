...
const bundle = {
  ...
  pendingFirstDollarEnvStaged: handoffData?.pendingFirstDollarEnvStaged === true,
  pendingFirstDollarEnvActivationReady: handoffData?.pendingFirstDollarEnvActivationReady === true,
  pendingFirstDollarEnvManifest: handoffData?.pendingFirstDollarEnvManifest || null,
  pendingFirstDollarEnvActivationApprovalPhrase: handoffData?.pendingFirstDollarEnvActivationApprovalPhrase || null,
  pendingFirstDollarEnvActivationInspectionCommand: handoffData?.pendingFirstDollarEnvActivationInspectionCommand || 'npm run -s print:first-dollar-pending-env-activation',
