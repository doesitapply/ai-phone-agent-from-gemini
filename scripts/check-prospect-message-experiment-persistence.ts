...
async function main(): Promise<void> {
  ...
  console.log(
    JSON.stringify(
      {
        ok: true,
        mode: "prospect-message-experiment-persistence-v8",
        ...
        controllerRequiresMeasuredOutcomeAndElapsedWindow: true,
        closureObservationWindowReceiptBound: true,
        controllerReturnsExactOperatorFocus: true,
        dashboardRejectsSampleDriftedRecommendation: true,
        dashboardAndControllerRejectAttritionCandidate: true,
        networkAttempts: 0,
        externalMessages: 0,
        spendCents: 0,
