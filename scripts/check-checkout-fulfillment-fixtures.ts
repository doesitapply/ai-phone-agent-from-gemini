...
// ── Retired founders $99 lane: must never be fulfillment authority ────────────
...
assert.deepEqual(foundersProof, {
  ok: true,
  source: "payment_link",
  ignored: true,
}, "a configured legacy founders link must be ignored and never fulfill a workspace");
