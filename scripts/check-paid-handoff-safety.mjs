...
requireIncludes("paid handoff live smoke", paidHandoff, 'starterPlan?.price === 197');
requireIncludes("paid handoff live smoke", paidHandoff, 'starterPlan?.checkout_available === true');
requireIncludes("paid handoff live smoke", paidHandoff, 'proPlan?.checkout_available === false');
requireIncludes("paid handoff live smoke", paidHandoff, 'enterprisePlan?.checkout_available === false');
requireIncludes("paid handoff live smoke", paidHandoff, 'plan: "starter"');
