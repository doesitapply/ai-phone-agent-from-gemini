...
Seventh researched batch: `docs/launch/prospect-batch-007-salt-lake-expansion.csv`.
Eighth researched batch: `docs/launch/prospect-batch-008-fresno-expansion.csv`.
...
npm run import:launch-ledger:batch -- docs/launch/prospect-batch-007-salt-lake-expansion.csv
...
- Redacted walkthrough clip has been captured with `npm run capture:launch-walkthrough`.
